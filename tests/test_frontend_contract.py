...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_workbench_uses_thought_chain_and_existing_api_routes(self):
        ...
        self.assertIn('import { DownOutlined } from "@ant-design/icons";', source)
        ...
        self.assertIn('.thought-icon-read-file svg,.thought-icon-write-file svg,.thought-icon-edit-file svg,.thought-icon-audit svg{width:12px;height:12px}', styles)

...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_mission_file_panel_draws_available_ontology_layers(self):
        ...
        self.assertIn('const capacity = computeTrackCapacity(radius, TAU, layerWidth, minGap);', layout_module)
        self.assertIn('fitRingWithoutOverlap(batch, radius, center, placed, minGap)', layout_module)
        ...
        self.assertIn('scaledTypography(13, fitScale, roamZoom)', source)

...
当前版本：`v0.1.1`（仓库最新正式版本，已部署至当前服务器线上）
...
两个服务的产品名称均为 **硕磐智能建模**，产品显示版本均为 **v0.1.1**（当前服务器线上已部署 v0.1.1）。
...
仓库最新正式版本：[`v0.1.1`](./docs/versions/v0.1.1.md)（已定版、已部署）
当前线上服务器版本：`v0.1.1`

后续版本遵循语义化版本规则：修复和小调整增加 PATCH，一组明显新能力增加 MINOR；版本升级由实际变化决定，不按日期机械升级。

- [v0.1.1](./docs/versions/v0.1.1.md)：已定版、已部署，仓库最新正式版本
- [v0.1.0](./docs/versions/v0.1.0.md)：已定版、历史版本
